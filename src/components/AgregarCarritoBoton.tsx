...
export const AgregarCarritoBoton: React.FC<AgregarCarritoBotonProps> = ({
  ...
  return (
    <button
      ...
      className="flex justify-center item-center bg-yellow p-4 w-full max-w-[280px] mt-2 rounded-[8px] hover:bg-yellow-900 hover:text-gray-dark disabled:opacity-25 disabled:hover:bg-yellow disabled:cursor-not-allowed">
      <MdAddShoppingCart className="size-4 h-full w-[20px]" />
      <span className="px-2 text-lg">Agregar al carrito</span>
    </button>
  );
};
