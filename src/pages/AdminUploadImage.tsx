...
export const AdminUploadImage = () => {
  ...
  const uploadImage = async () => {
    ...
    try {
      const response = await fetch(getImageEndpoint(`${API_URL}/${id}/cargarimagen`), {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <div className="mb-4">
      ...
      <div className="relative">
        ...
        />
        <button type="button" className="form-input mt-1 block w-full border p-3 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" onClick={uploadImage}>
