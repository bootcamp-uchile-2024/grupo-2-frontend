  ...
  return (
    <MainLayout>
      <div className="contenido">
        ...
        <p>
          En esta sección se administran los usuarios y el productos de la
          aplicación.
        </p>
        <div className="wrapper-botones">
          <Link to="crea-usuario">
            <button
              className={`btn ${
                pathname == "/admin/crea-usuario" ? "btn-selected" : null
              }`}
            >
          ...
          <Link to="crea-producto">
            <button
              className={`btn ${
                pathname == "/admin/crea-producto" ? "btn-selected" : null
              }`}
            >
